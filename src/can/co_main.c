...
static const char * function2str(uint16_t function, uint8_t node)
{
	if (function == CO_FUNCTION_SYNC && node == 0)
		return "SYNC";

	switch(function)
	{
	case CO_FUNCTION_NMT: return "NMT";
	case CO_FUNCTION_TIME: return "TIME";
	case CO_FUNCTION_EMCY: return "EMCY";
	case CO_FUNCTION_PDO1_TX: return "PDO1_TX";
	case CO_FUNCTION_PDO1_RX: return "PDO1_RX";
	case CO_FUNCTION_PDO2_TX: return "PDO2_TX";
	case CO_FUNCTION_PDO2_RX: return "CO_FUNCTION_EMCY";
	case CO_FUNCTION_PDO3_TX: return "PDO3_TX";
	case CO_FUNCTION_PDO3_RX: return "PDO3_RX";
	case CO_FUNCTION_PDO4_TX: return "PDO4_TX";
	case CO_FUNCTION_PDO4_RX: return "PDO4_RX";
	case CO_FUNCTION_SDO_TX: return "SDO_TX";
	case CO_FUNCTION_SDO_RX: return "SDO_RX";
	case CO_FUNCTION_NMT_ERR: return "NMT_ERR";
	case CO_FUNCTION_LSS: return "LSS";
...
void co_handle_rx (co_net_t * net)
{
   ...
   do
   {
      ...
      if (status == 0)
      {
         ...
         LOG_DEBUG (CO_CAN_LOG, "--> can-rx id:0x%x node_id:0x%x [%s] %d bytes\n", id, node, function2str(function, node), dlc);
